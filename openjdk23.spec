...
Obsoletes:	jdk
Obsoletes:	kaffe
Obsoletes:	openjdk23-jdk < 23.0.2-2
Obsoletes:	oracle-java7
...
Provides:	jdk(%{name})
Obsoletes:	openjdk23-jdk-base < 23.0.2-2
...
Obsoletes:	jre
Obsoletes:	jsse
Obsoletes:	openjdk23-jre < 23.0.2-2
Obsoletes:	oracle-java7-jre
...
Provides:	jre(%{name})
Obsoletes:	openjdk23-jre-base < 23.0.2-2
...
Obsoletes:	openjdk23-jre-base-X11 < 23.0.2-2
...
Obsoletes:	openjdk23-jre-base-freetype < 23.0.2-2
...
Obsoletes:	jar
Obsoletes:	openjdk23-jar < 23.0.2-2
